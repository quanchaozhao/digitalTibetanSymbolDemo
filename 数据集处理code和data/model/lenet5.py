...
model.add(Convolution2D(16, 5, 5, border_mode='valid', init = 'uniform'))
model.add(Activation('relu'))
#model.add(PReLU(init='zero', weights=None))
...
model.add(Convolution2D(120, 5, 5, border_mode='valid', init = 'uniform'))
model.add(Activation('relu'))
...
model.add(Dense(84, init = 'uniform'))
model.add(Activation('relu'))
...
model.fit(X_train, Y_train, batch_size=batch_size, nb_epoch=100,show_accuracy=True, verbose=1, validation_data=(X_test, Y_test))
