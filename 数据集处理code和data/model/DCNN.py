...
model.add(Convolution2D(450, 2, 2, border_mode='valid', init = 'uniform'))
model.add(Activation('relu'))
model.add(MaxPooling2D(pool_size=(2, 2), strides=(2,2)))


model.add(Convolution2D(600, 2, 2, border_mode='valid', init = 'uniform'))
model.add(Activation('relu'))
model.add(MaxPooling2D(pool_size=(2, 2), strides=(2,2)))
...
model.add(Dense(900, init = 'uniform'))
model.add(Activation('relu'))
